...
- **Description:** This dataset includes counts of social media posts that mention COVID-19 for each included county, though the Midwest suffers from a paucity of data as time progresses. This data is provided per week starting in January, 2020, and is updated through August, but we only use the data starting in April due to the time constraints of our other datasets, particularly the CDC anxiety and depression data.
